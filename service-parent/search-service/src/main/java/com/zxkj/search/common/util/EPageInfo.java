package com.zxkj.search.common.util;
...
public class EPageInfo implements Serializable {
     ...
     * @param offsize
     */
    public EPageInfo(long total, int currentpage, int pagesize, int offsize) {
     ...
     */
    public EPageInfo(long total, int currentpage, int pagesize) {
        initPage(total, currentpage, pagesize);
    }
