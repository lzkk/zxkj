...
public class MyZoneAvoidanceRule extends ZoneAvoidanceRule {
    ...
    private class MyServerPredicate extends AbstractServerPredicate {
        ...
        public List<Server> getEligibleServers(List<Server> servers, Object loadBalancerKey) {
            ...
            String greyPublishStr = GreyUtil.getCurrentContext().getGreyPublish();
            String regionPublishStr = GreyUtil.getCurrentContext().getRegionPublish();
            List<Server> matchResults = Lists.newArrayList();
            for (Server server : serverList) {
                if (server instanceof NacosServer) {
                    NacosServer nacosServer = (NacosServer) server;
                    if (developEnvMatch(server) && greyMatch(nacosServer, greyPublishStr, regionPublishStr)) {
            ...
            if (matchResults.size() == 0) {
                ...
                return compatibleMatch(serverList, greyPublishStr, regionPublishStr);
            }
            return matchResults;
        }
         ...
         * @return
         */
        private boolean greyMatch(NacosServer nacosServer, String greyPublishStr, String regionPublishStr) {
            ...
            String reqGrey = greyPublishStr + "-" + regionPublishStr;
         ...
         * @return
         */
        private List<Server> compatibleMatch(List<Server> serverList, String greyPublishStr, String regionPublishStr) {
